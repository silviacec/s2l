<template lang="html">
  ...
  <section id="project_ca-commence-par-moi_content" class="content_part content_project" data-color="#C6E3D7" style="background-color: rgb(198, 227, 215); height: 44.5em;">
                ...
                <article id="project_ca-commence-par-moi_description" class="project_description">
                  ...
                  <div class="project_description_cont">
                    ...
                    <div class="project_text">
                          <p>Ecolo bobo carnivore free  <a href="https://www.facebook.com/cacommenceparmoi.org/" title="" target="_blank">"ça commence par moi"</a>, community launch by Julien Vidal to build a better world!</p>
                    </div>
                  </div>
                </article>

                <div id="project_ca-commence-par-moi_number" class="project_number">001</div>

                <div class="table">
                  <div class="project_images">
                    <figure class="project_image odd first">
                      <img alt="img-01.jpg" src="img-01.jpg">
                    </figure>
                    <figure class="project_image even first">
                      <img alt="img-03.jpg" src="img-03.jpg">
                    </figure>
                    <figure class="project_image odd">
                      <img alt="img-02.jpg" src="img-00.jpg">
                    </figure>
                    <figure class="project_image even">
                      <img alt="img-04.jpg" src="img-04.jpg">
                    </figure>
                  </div>
                </div>
              </div>
...
.paragraphs {
  padding-bottom: 2em;
    background-image: : url('Images/background4.jpg') center no-repeat !important;
...
.project_title {
  display: inline;
  font: normal 17px/30px 'f24e4d5d';
  border-bottom: 4px solid #fff;
}

.brief-recruiter{ /* besoin de changer la police qui est introuvable */
  font-family: 'f24e4d5d',"Helvetica Neue","Helvetica","Arial";
  font-size: 14px;
  line-height: 17px;
  color: #000;
}
...
#project_cacao-forest_description{
  display: block;
  margin-top: 110em;
  margin-right: 20em;
}

#project_please-come-inside_description{
  display: block;
  margin-top: 166em;
  margin-right: 20em;
}
