<template>
<div class="contact">
  <span class="navbar__menu-item"><span data-menu-item-text="#investisseur" class="navbar__menu-item-title">#Contact</span>
  ...
  <form>
    ...
    <label class="feedback-select" for="amount">Montant indicatif à investir : </label>
    <select class="feedback-select" name="amount" id="amount">
        <option value="pas">je ne sais pas !</option>
